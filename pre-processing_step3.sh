...
VCF=./data_and_results/step3/dataset/gnomad.genomes.v3.1.2.hgdp_tgp.chr21.vcf.bgz
SAMPLEINFO=./data_and_results/step3/dataset/gnomad_meta_updated.tsv

# Output prefix to use
PREFIX=step3_admixture
DATA_DIR="./data_and_results/step3"
...
awk -F'\t' '
  ...
  ($39=="basque" || $39=="russian" || $39=="fin" || $39=="gbr" || $39=="ibs" || $39=="tsi" ) {
    print $1, $1
  }
' "$SAMPLEINFO" > "$KEEPFILE"
