...
VCF=./data_and_results/step2/dataset/ALL.chr21.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz
SAMPLEINFO=./data_and_results/step2/dataset/igsr_samples.tsv
...
awk -F'\t' '
  ...
  ($4=="FIN" || $4=="IBS" || $4=="GBR" || $4=="CEU" || $4=="TSI") && ($9 ~ /phase 3 release/) {
    print $1, $1
  }
' "$SAMPLEINFO" > "$KEEPFILE"
